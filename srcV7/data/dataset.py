...
class R2CacheDataset(Dataset):
    ...
    def _crop(self, item: dict[str, Any]) -> dict[str, Any]:
        ...
        start = self.rng.randint(0, v_len - self.max_frames) if self.random_crop else 0
...
def collate_r2cache(batch: list[dict[str, Any]]) -> dict[str, Any]:
