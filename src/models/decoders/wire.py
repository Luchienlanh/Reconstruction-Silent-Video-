...
class TFiLMWIREDecoder(nn.Module):
    def __init__(self, condition_dim=512, hidden_dim=256, out_dim=640, num_layers=4, omega_zero=30.0, scale=5.0, use_conv=False, output_activation="tanh", output_bias_init=-4.0):
        super().__init__()
