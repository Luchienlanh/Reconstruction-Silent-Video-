...
from .base_layers import DualFiLMLayer, DualWrapLayer
from .siren import FiLMSIREN
from .wire import FiLMWIRE
from .finer import FiLMFINER

class DualDecoder(nn.Module):
    def __init__(self, condition_dim=512, hidden_dim=256, out_dim=640, num_layers=4, omega_siren=30.0, omega_wire=30.0, scale=5.0, use_conv=False, output_activation="tanh"):
        super().__init__()
