...
from srcV4.inference.overlap_add import build_model_from_checkpoint
from srcV4.models import V4MelLoss
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Ablate srcV4 checkpoint on window samples.")
...
def run(args: argparse.Namespace) -> None:
    ...
    criterion = V4MelLoss(ckpt["mel_mean"], ckpt["mel_std"]).to(device)
