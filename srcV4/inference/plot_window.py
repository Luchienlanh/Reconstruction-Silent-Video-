...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Plot one srcV4 window prediction against target mel.")
    parser.add_argument("--data-dir", default="Processed_Data_R2INR_LRS2")
    parser.add_argument("--checkpoint", required=True)
    parser.add_argument("--output-dir", default="inference_srcV4_window")
